...
export class RectTool extends BaseTool {
    constructor(state, workspace, shapeIdCounterRef) {
        ...
        this.shapeType = 'rect'; // 자신의 역할을 명확하게 하드코딩
        console.log(`[CLASS RectTool] 사각형 그리기 독립 도구 초기화 완료`);
    }
    ...
    onMouseDown(e) {
        ...
        if (!this.state.isDrawing) {
            ...
            console.log(`[RECT-TOOL] 신규 사각형 생성 시작 | ID: shape_${this.shapeIdCounterRef.value}`);
    ...
    completeDrawing() {
        console.log(`[RECT-TOOL] 사각형 완성 확정 (연속 그리기 대기)`);
    ...
    cancelDrawing() {
        ...
        console.log(`[RECT-TOOL] 사각형 그리기 취소`);
