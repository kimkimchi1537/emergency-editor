...
export class ShapeRenderer {
    ...
    render(isSelected, isRotating) {
        console.log(`[LOG] js/shapes/ShapeRenderer.js: render 실행 (ID: ${this.data.id}, Selected: ${isSelected})`);
    ...
    createDimensionGroup(isSelected) {
        console.log(`[LOG] js/shapes/ShapeRenderer.js: createDimensionGroup 호출 (ID: ${this.data.id})`);
    ...
    createGeometry() { 
        console.log(`[LOG] js/shapes/ShapeRenderer.js: createGeometry (추상)`);
        return null; 
    } 
    createHitArea() { 
        console.log(`[LOG] js/shapes/ShapeRenderer.js: createHitArea (추상)`);
        return null; 
    }
    createDimension() { 
        console.log(`[LOG] js/shapes/ShapeRenderer.js: createDimension (추상)`);
        throw new Error("createDimension() must be implemented."); 
    }
    getDimensionRefPoint() { 
        console.log(`[LOG] js/shapes/ShapeRenderer.js: getDimensionRefPoint (추상)`);
        throw new Error("getDimensionRefPoint() must be implemented."); 
    }
    createHighlight() { 
        console.log(`[LOG] js/shapes/ShapeRenderer.js: createHighlight (추상)`);
        return null; 
    }
